...
class Habit(models.Model):
    ...
    owner = models.ForeignKey('users.User', on_delete=models.CASCADE, verbose_name='юзер', **NULLABLE)
    ...
    reward = models.CharField(max_length=150, verbose_name='похвала', **NULLABLE)
